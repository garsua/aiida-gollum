...
def upload_psf_family(folder,
    ...
    #from aiida.orm.user import UserCollection
    from aiida.orm import user as uuser
    ...
    try:
        ...
        group = Group(
            ...
            #user='vm.garcia@cinn.es')
            #user=gauser.get_automatic_user)
        group_created = True

    #if group.user != gauser.get_automatic_user():
